...
/**
 * Class representing a fully localizable JMenu. It is a listener registered on the localization
...
public class LJMenu extends JMenu implements ILocalizationListener {
	 ...
	 * 
	 * @param key key based on which the LJMenu will get the adequate String from the localization provider
