...
<%@page import="hr.fer.zemris.java.hw16.model.BlogEntry,hr.fer.zemris.java.hw16.model.BlogComment"%>
...
<html>
  ...
  <% } else { %>
    ...
    <% } %>
  <% } %>
  <a href="/aplikacija5/servleti/call-login">Login</a>
  <a href="/aplikacija5/servleti/call-register">New user</a>
