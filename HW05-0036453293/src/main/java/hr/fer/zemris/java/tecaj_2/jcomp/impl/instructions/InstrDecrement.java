...
/**
 * Class used to support the microprocessor operation decrement. Only constructor parameter register is the 
 * destination register. Its value is lowered by 1.
 * 
 * @author MarkoB
 * @version 1.0
 */
public class InstrDecrement implements Instruction {
	 ...
	 * 
	 * @param arguments register of the processor whose value is to be decreased
	 */
	 ...
	 * 
	 * Method decreases the value of the selected register by 1.
	 */
	@Override
