...
import hr.fer.zemris.web.dao.sql.SQLConnectionProvider;
...
/**
 * Filter used to stop all the requests sent to /servleti/* and assign them their private connection to the
 * database.
 * 
 * @author MarkoB
 * @version 1.0
...
public class ConnectionSetterFilter implements Filter {
	 ...
	 *  
	 *  Method assigns a connection to every request thread coming in.
	 */
	@Override
